    ...
    while (game_over == false)
    {
        ...
        while (round_over == false)
        {
            ...
            while (valid_play == false && plays_available > 0)
            {
                ...
                std::cout << computer_play_char << " The computer played " << computer_play << ".\n";
                for (int i = 0; i < 3; i++)
                {
                    for (int j = 0; j < 3; j++)
                    {
        ...
        char play_again;
        std::cin >> play_again;
        if (play_again == 'y' || play_again == 'Y' || play_again == 'yes' || play_again == 'Yes' || play_again == 'YES' || play_again == 'yES' || play_again == 'YeS' || play_again == 'yEs' || play_again == 'yeS')
        {
            game_over = false;
            round_over = false;
            plays_available = 9;
